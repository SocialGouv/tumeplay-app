                ...
                const _questions = [
                        {
                                key: 'boarding-1',
                                title: 'Bienvenue !',
                                text: 'L\'application qui te permet d\'en apprendre plus sur la sexualité.',
                        ...
                        },
                        {
                                key: 'boarding-3',
                                title: 'Teste toi !',
                                text: 'Réponds à nos quizz pour tester tes connaissances et gagne des points.',
                                picture: require('./assets/pictures/boarding/boarding-2.jpeg'),
                        },
                        {
                                key: 'boarding-4',
                                title: 'Reçois ta box !',
                                text: 'Commande une de nos box remplie de préservatifs et autres accessoires gratuitement.',
                                picture: require('./assets/pictures/boarding/boarding-1.jpeg'),
                        },
                        {
                                key: 'boarding-5',
                                title: 'Besoin d\'aide ?',
                                text: 'Nous sommes aussi là pour t\'orienter au bon endroit en cas de besoin.',
