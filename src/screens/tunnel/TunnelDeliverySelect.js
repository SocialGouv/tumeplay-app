...
import {Text, View, Image, TouchableOpacity, YellowBox} from 'react-native';
      ...
      <View
        ...
        <View style={{flex: 0.4}}>
          ...
          <Text style={{color: '#FFFFFF', fontSize: 16, marginTop: 15}}>
            Nous te livrons sous 4 jours à domicile ou en points relais mais tu
            peux choisir nos pharmacies partenaires et venir récupérer ton colis
            le jour même.
          </Text>
        </View>
