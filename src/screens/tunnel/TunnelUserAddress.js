    ...
    return (
      <ScrollView
        ...
        <View style={flexstyle}>
          ...
          <TextInput placeholder="Ton Prénom" style={Styles.inputTypeText} />
        </View>

        <View style={flexstyle}>
          <Text style={Styles.labelText}>Nom *</Text>
          <TextInput placeholder="Ton Nom" style={Styles.inputTypeText} />
        </View>
        <View style={flexstyle}>
        ...
        <View style={flexstyle}>
          ...
          <TextInput placeholder="Ton adresse" style={Styles.inputTypeText} />
        </View>
        <View
          style={{
            flex: 0.08,
